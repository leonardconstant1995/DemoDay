$(document).ready(function() {
    ...
    $(document).on("click", ".conversation-panel .friend-section .friend-box", function() {
        ...
        chatPopup =
            ...
            '<ul>' +
            '<li><img src="/svg/video.svg"></li>' +
            '<li><img src="/svg/phone.svg"></li>' +
            '<li><img src="/svg/settings.svg"></li>' +
            '<li class="close-chat"><img src="/svg/x.svg"></li>' +
            '</ul>' +
            '</div>' +
            '</a>' +
            ...
            '<div class="options">' +
            '<ul>' +
            '<li><img src="/svg/image.svg"></li>' +
            '<li><img src="/svg/paperclip.svg"></li>' +
            '<li><img src="/svg/camera.svg"></li>' +
            '</ul>' +
            '</div>' +
            '</div>' +
            '</div></div></div>';
